...
public class MontantCommandeClient {
    ...
    public static void Lafonction(String nom, int numer0)
    {
        ...
        try {
            ...
            String sql = "SELECT prixunit, qteCom, designation, prixUnit*qteCom " +
                            "FROM produit, detail.com " +
                            "WHERE client.numcl = 1 AND clientclient.numcl = commande.numcl = 1 " +
                            "AND commande.numCom = detailcom.numcom " +
                            "AND detailcom.numprod = produit.numprod " //5 : Exécution de la requête
