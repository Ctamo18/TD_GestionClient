...
public class CinemaQuartier { //com.mysql.cj.jdbc.Driver
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String selection = "SELECT cinema.nomC, comprend.nomM  FROM cimena, comprend WHERE " +
                    "cinema.nomM= 'nation' AND cinema.nomM = comprend.nomM  ";
            rs = st.executeQuery(selection);
            System.out.println(""); // Traitement du r�sultat
            System.out.println("=================================");
            while(rs.next()) {
